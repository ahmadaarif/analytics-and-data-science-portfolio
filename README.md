Hi, I’m **Ahmad Arif**, a **Data Analyst / Business Analytics graduate** with a background in Computer Science.  
This portfolio showcases **end-to-end analytics projects** focused on turning data into actionable business insights using **Python, SQL, and Power BI**.
...
- Validated Python analysis using **SQL (SQLite)**  
...
- **Data Handling:** Large datasets, sampling, data cleaning  
